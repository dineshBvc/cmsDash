...
var clientHydrate = function(e, t, r, n, a, i, o) {
  ...
  if (i.nodeType === 1) {
    ...
    if (l) {
      s = l.split(".");
      if (s[0] === o || s[0] === "0") {
        u = { p: 0, _: s[0], C: s[1], N: s[2], R: s[3], h: i.tagName.toLowerCase(), m: i, o: null, l: null, u: null, v: null, i: null };
        t.push(u);
    ...
    if (s[1] === o || s[1] === "0") {
      l = s[0];
      u = { p: 0, _: s[1], C: s[2], N: s[3], R: s[4], m: i, o: null, l: null, u: null, v: null, h: null, i: null };
      if (l === TEXT_NODE_ID) {
        u.m = i.nextSibling;
    ...
    if (typeof i === "string") {
      ...
      if (!o.has(a)) {
        if (e.host && (l = e.querySelector("[".concat(HYDRATED_STYLE_ID, '="').concat(a, '"]')))) {
          ...
          l.innerHTML = i;
          var s = (n = plt.$) != null ? n : queryNonceMetaTagContent(doc2);
          if (s != null) {
...
var attachStyles = function(e) {
  ...
  var r = e.$hostElement$;
  var n = t.p;
  var a = createTime("attachStyles", t.A);
        ...
        if (!t["s-cn"] && !t["s-nr"] && t["s-hn"] !== o["s-hn"] && (!t["s-sh"] || t["s-sh"] !== o["s-hn"])) {
          if (isNodeLocatedInSlot(t, l)) {
            ...
            if (e2) {
              ...
              t["s-sh"] = o["s-hn"];
              relocateNodes.push({ I: o, H: t });
            }
            if (t["s-sr"]) {
              relocateNodes.map(function(r2) {
                if (isNodeLocatedInSlot(r2.H, t["s-sn"])) {
...
var renderVdom = function(e, t, r) {
  ...
  patch(f, c, r);
  {
    ...
    if (checkSlotRelocate) {
      ...
      for (var _ = 0, C = relocateNodes; _ < C.length; _++) {
        var g = C[_];
        var y = g.H;
        var b = g.I;
        if (b) {
  ...
  if (u.p & 2) {
    for (var R = 0, D = c.m.childNodes; R < D.length; R++) {
      var $ = D[R];
      if ($["s-hn"] !== hostTagName && !$["s-sh"]) {
        if (r && $["s-ih"] == null) {
          $["s-ih"] = (l = $.hidden) != null ? l : false;
        }
        $.hidden = true;
      }
    }
...
var dispatchHooks = function(e, t) {
  var r = e.$hostElement$;
  var n = createTime("scheduleUpdate", e.k.A);
  var a = e.V;
  if (!a) {
...
var updateComponent = function(e, t, r) {
  return __awaiter(void 0, void 0, void 0, function() {
    ...
    return __generator(this, function(f) {
      a = e.$hostElement$;
      i = createTime("update", e.k.A);
      o = a["s-rc"];
      if (r) {
        attachStyles(e);
      }
      l = createTime("render", e.k.A);
      {
        callRender(e, t, a, r);
      }
      if (o) {
...
var setValue = function(e, t, r, n) {
  var a = getHostRef(e);
  if (!a) {
    throw new Error(`Couldn't find host element for "`.concat(n.A, '" as it is unknown to this Stencil runtime. This usually happens when integrating a 3rd party Stencil component with another Stencil component or application. Please reach out to the maintainers of the 3rd party Stencil component or report this on the Stencil Discord server (https://chat.stenciljs.com) or comment on this similar [GitHub issue](https://github.com/ionic-team/stencil/issues/5457).'));
  }
  var i = a.$hostElement$;
  var o = a.B.get(t);
  var l = a.p;
      ...
      if (i2 & 31 || r & 2 && i2 & 32) {
        ...
        Object.defineProperty(a, n2, { value: function() {
          ...
          return (r2 = a2 == null ? void 0 : a2.Y) == null ? void 0 : r2.then(function() {
            var t3;
            return (t3 = a2.V) == null ? void 0 : t3[n2].apply(t3, e3);
          });
        } });
      }
    });
  ...
  return __awaiter(void 0, void 0, void 0, function() {
    ...
    return __generator(this, function(p) {
      switch (p.label) {
        ...
        case 3:
          if (!n2) {
            throw new Error('Constructor for "'.concat(r.A, "#").concat(t.D, '" was not found'));
          }
          if (!n2.isProxied) {
            {
              r.q = n2.watchers;
          ...
          l = createTime("createInstance", r.A);
          {
            t.p |= 8;
          }
          try {
        ...
        case 5:
          if (n2 && n2.style) {
            ...
            f = getScopeId(r, t.D);
            if (!styles.has(f)) {
              c = createTime("registerStyles", r.A);
              registerStyle(f, u, !!(r.p & 1));
              c();
            }
          }
          p.label = 6;
...
var connectedCallback = function(e) {
  if ((plt.p & 1) === 0) {
    var t = getHostRef(e);
    var r = t.k;
    var n = createTime("connectedCallback", r.A);
    if (!(t.p & 1)) {
      t.p |= 1;
      var a = void 0;
      {
        ...
        if (a) {
          ...
          initializeClientHydrate(e, r.A, a, t);
        }
      }
      if (!a) {
        if (r.p & (4 | 8)) {
...
var bootstrapLazy = function(e, t) {
  ...
  e.map(function(e2) {
    e2[1].map(function(t2) {
      var r2;
      var n2 = { p: t2[0], A: t2[1], U: t2[2], X: t2[3] };
      if (n2.p & 4) {
        h2 = true;
      }
      {
  ...
  if (a.length > 0) {
    ...
    if (u.innerHTML.length) {
      ...
      var m = (r = plt.$) != null ? r : queryNonceMetaTagContent(doc2);
      if (m != null) {
...
@ionic/core/dist/esm-es5/index-92f14156.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4HZ7CWEW.js.map
