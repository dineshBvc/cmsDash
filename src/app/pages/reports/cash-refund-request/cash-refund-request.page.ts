...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonRow, IonCol, IonButton, IonSearchbar, IonIcon, IonButtons, IonSelect, IonSelectOption, IonDatetime, IonDatetimeButton, IonModal, IonBadge } from '@ionic/angular/standalone';
import { ApiService } from 'src/app/services/api.service';
import { AlertService } from 'src/app/services/alert.service';

@Component({
  selector: 'app-cash-refund-request',
  templateUrl: './cash-refund-request.page.html',
  styleUrls: ['./cash-refund-request.page.scss'],
  standalone: true,
  imports: [IonBadge, IonDatetime, IonModal, IonDatetimeButton, IonButtons, IonIcon, IonSearchbar, IonButton, IonCol, IonRow, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, IonSelect, IonSelectOption]
})
export class CashRefundRequestPage {
  ...
  OnMarkAsPaid(orderNumber: string, mobileNumber: string) {
  ...
  OnDownload() {
    this.api.DownloadCashRefundReport(this.fromDate, this.toDate).subscribe(
      (data) => {
