...
@Component({
  ...
  templateUrl: './sales-product.page.html',
  styleUrls: ['./sales-product.page.scss'],
  standalone: true,
...
export class SalesProductPage  {
  ...
  OnDownload() {
    ...
    this.api.DownloadSalesProductReport(this.machineList.selectedId, this.fromDate, this.toDate).subscribe(
      (data) => {
