...
@Component({
  ...
  templateUrl: './sales-user.page.html',
  styleUrls: ['./sales-user.page.scss'],
  standalone: true,
...
export class SalesUserPage {
  ...
  OnDownload() {
    ...
    this.api.DownloadSalesUserReport(this.machineList.selectedId, this.fromDate, this.toDate).subscribe(
      (data) => {
