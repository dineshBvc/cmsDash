...
@Component({
  ...
  templateUrl: './stock-refill.page.html',
  styleUrls: ['./stock-refill.page.scss'],
  standalone: true,
...
export class StockRefillPage {
  ...
  OnDownload() {
    ...
    this.api.DownloadRefillReport(this.machineList.selectedId, this.fromDate, this.toDate).subscribe(
      (data) => {
