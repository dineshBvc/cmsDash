...
// src/app/interfaces/chart-options.ts
var ChartGenerator = class {
  GetDailySalesChartOptions(sales, labels) {
    var options = {
      ...
      xaxis: {
        categories: labels,
        labels: { style: { colors: ["#008FFB", "#00E396", "#FEB019", "#FF4560", "#775DD0", "#546E7A", "#26a69a"], fontSize: "12px" } }
      },
      yaxis: {}
    };
    return options;
  }
  GetMonthlySalesChartOptions(sales, labels) {
    var options = {
      series: [{ name: "Amount(\u20B9) ", data: sales }],
      chart: {
        type: "area",
      ...
      xaxis: {
        categories: labels,
        labels: { style: { colors: ["#008FFB", "#00E396", "#FEB019", "#FF4560", "#775DD0", "#546E7A", "#26a69a", "#D10CE8", "#ce6868", "#ff8000", "#400000", "#279e39"], fontSize: "12px" } }
      },
      yaxis: {}
    };
    return options;
  }
  GetProductSalesChart(values, products) {
    var options = {
      chart: {
        height: 320,
        type: "pie",
