...
} from "./chunk-ADCISGIA.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-KS33RXXU.js";
import "./chunk-Q535AENF.js";
import {
  isRTL
} from "./chunk-6LTS2OT5.js";
import {
  createLockController
} from "./chunk-R2AU7QJV.js";
import "./chunk-TECVDSEG.js";
import {
  transition
} from "./chunk-66NQU5P4.js";
import {
...
import {
  attachComponent,
  detachComponent
} from "./chunk-3H2XENQN.js";
import {
  createColorClasses,
  hostContext
} from "./chunk-2HSCIEP3.js";
import {
  printIonWarning
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./chunk-7PSPHIYY.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./chunk-56VSGB4F.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./chunk-LADAB6PR.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./chunk-U5AWL3OR.js");
        ...
        if (typeof window !== "undefined") {
          import("./chunk-DTY4IUGX.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./chunk-UN2LWOUG.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
  /**
...
var Content = class {
  ...
  render() {
    ...
    this.resize();
    return h(Host, { key: "f599a7da14969df38c20a6f650179d2a319fb58b", role: isMainContent ? "main" : void 0, class: createColorClasses(this.color, {
      [mode]: true,
    ...
    } }, h("div", { key: "7c545c3c95ea05abd036d0462936ac153d2a8fc6", ref: (el2) => this.backgroundContentEl = el2, id: "background-content", part: "background" }), fixedSlotPlacement === "before" ? h("slot", { name: "fixed" }) : null, h("div", { key: "a67ab7438466c99f74b7ba59964802c3ba86ac5b", class: {
      "inner-scroll": true,
      "scroll-x": scrollX,
      "scroll-y": scrollY,
      overscroll: (scrollX || scrollY) && forceOverscroll
    }, ref: (scrollEl) => this.scrollEl = scrollEl, onScroll: this.scrollEvents ? (ev) => this.onScroll(ev) : void 0, part: "scroll" }, h("slot", { key: "6d10fcac2e40b4dd6c20d91a8957ac07251d2fa7" })), transitionShadow ? h("div", { class: "transition-effect" }, h("div", { class: "transition-cover" }), h("div", { class: "transition-shadow" })) : null, fixedSlotPlacement === "after" ? h("slot", { name: "fixed" }) : null);
  }
  get el() {
    return getElement(this);
  }
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./chunk-ZVZVY345.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
