...
// src/app/pages/reports/stock-refill/stock-refill.page.ts
function StockRefillPage_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-datetime", 19);
    \u0275\u0275twoWayListener("ngModelChange", function StockRefillPage_ng_template_15_Template_ion_datetime_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r1);
...
function StockRefillPage_ng_template_23_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-datetime", 20);
    \u0275\u0275twoWayListener("ngModelChange", function StockRefillPage_ng_template_23_Template_ion_datetime_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function StockRefillPage_ion_row_27_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-row", 2)(1, "ion-col", 21)(2, "ion-toolbar", 0)(3, "ion-searchbar", 22);
    \u0275\u0275listener("ionInput", function StockRefillPage_ion_row_27_Template_ion_searchbar_ionInput_3_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function StockRefillPage_ion_row_27_Template_ion_button_click_5_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
...
function StockRefillPage_div_28_ion_icon_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "ion-icon", 35);
  }
}
function StockRefillPage_div_28_ion_icon_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "ion-icon", 36);
  }
}
function StockRefillPage_div_28_ion_icon_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "ion-icon", 35);
  }
}
function StockRefillPage_div_28_ion_icon_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "ion-icon", 36);
  }
}
function StockRefillPage_div_28_ion_icon_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "ion-icon", 35);
  }
}
function StockRefillPage_div_28_ion_icon_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "ion-icon", 36);
  }
}
function StockRefillPage_div_28_ion_icon_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "ion-icon", 35);
  }
}
function StockRefillPage_div_28_ion_icon_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "ion-icon", 36);
  }
}
function StockRefillPage_div_28_ion_icon_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "ion-icon", 35);
  }
}
function StockRefillPage_div_28_ion_icon_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "ion-icon", 36);
  }
}
function StockRefillPage_div_28_ion_icon_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "ion-icon", 35);
  }
}
function StockRefillPage_div_28_ion_icon_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "ion-icon", 36);
  }
}
function StockRefillPage_div_28_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 26)(1, "ion-row", 15)(2, "ion-col", 16)(3, "ion-row", 27)(4, "ion-col", 28);
    \u0275\u0275listener("click", function StockRefillPage_div_28_Template_ion_col_click_4_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.sortBy("date"));
    });
    \u0275\u0275text(5, " Date ");
    \u0275\u0275template(6, StockRefillPage_div_28_ion_icon_6_Template, 1, 0, "ion-icon", 29)(7, StockRefillPage_div_28_ion_icon_7_Template, 1, 0, "ion-icon", 30);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "ion-col", 31);
    \u0275\u0275listener("click", function StockRefillPage_div_28_Template_ion_col_click_8_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(12, " M ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, StockRefillPage_div_28_ion_icon_13_Template, 1, 0, "ion-icon", 29)(14, StockRefillPage_div_28_ion_icon_14_Template, 1, 0, "ion-icon", 30);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "ion-col", 34);
    \u0275\u0275listener("click", function StockRefillPage_div_28_Template_ion_col_click_15_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.sortBy("product"));
    });
    \u0275\u0275text(16, " Product ");
    \u0275\u0275template(17, StockRefillPage_div_28_ion_icon_17_Template, 1, 0, "ion-icon", 29)(18, StockRefillPage_div_28_ion_icon_18_Template, 1, 0, "ion-icon", 30);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "ion-col", 28);
    \u0275\u0275listener("click", function StockRefillPage_div_28_Template_ion_col_click_19_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.sortBy("price"));
    });
    \u0275\u0275text(20, " Price ");
    \u0275\u0275template(21, StockRefillPage_div_28_ion_icon_21_Template, 1, 0, "ion-icon", 29)(22, StockRefillPage_div_28_ion_icon_22_Template, 1, 0, "ion-icon", 30);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "ion-col", 31);
    \u0275\u0275listener("click", function StockRefillPage_div_28_Template_ion_col_click_23_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(27, " Q ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(28, StockRefillPage_div_28_ion_icon_28_Template, 1, 0, "ion-icon", 29)(29, StockRefillPage_div_28_ion_icon_29_Template, 1, 0, "ion-icon", 30);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "ion-col", 28);
    \u0275\u0275listener("click", function StockRefillPage_div_28_Template_ion_col_click_30_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(34, " Amt ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(35, StockRefillPage_div_28_ion_icon_35_Template, 1, 0, "ion-icon", 29)(36, StockRefillPage_div_28_ion_icon_36_Template, 1, 0, "ion-icon", 30);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function StockRefillPage_ion_row_32_Template(rf, ctx) {
  if (rf & 1) {
...
function StockRefillPage_div_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function StockRefillPage_div_33_Template_ion_button_click_15_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function StockRefillPage_div_33_Template_ion_button_click_18_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function StockRefillPage_div_33_Template_ion_select_ngModelChange_21_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.recordPerPage, $event) || (ctx_r1.recordPerPage = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("ionChange", function StockRefillPage_div_33_Template_ion_select_ionChange_21_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function StockRefillPage_div_33_Template_ion_button_click_31_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function StockRefillPage_div_33_Template_ion_button_click_34_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
...
var _StockRefillPage = class _StockRefillPage {
  constructor() {
  ...
  onShowClick() {
    ...
    this.api.GetRefillReport(this.machineList.selectedId, this.fromDate, this.toDate).subscribe((data) => {
      this.rawData = data;
  ...
  OnDownload() {
    ...
    this.api.DownloadRefillReport(this.machineList.selectedId, this.fromDate, this.toDate).subscribe((data) => {
...
_StockRefillPage.\u0275fac = function StockRefillPage_Factory(t) {
  return new (t || _StockRefillPage)();
};
_StockRefillPage.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StockRefillPage, selectors: [["app-stock-refill"]], viewQuery: function StockRefillPage_Query(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275template(15, StockRefillPage_ng_template_15_Template, 1, 2, "ng-template");
    \u0275\u0275elementEnd()()()();
    ...
    \u0275\u0275template(23, StockRefillPage_ng_template_23_Template, 1, 2, "ng-template");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(24, "ion-col", 3)(25, "ion-button", 11);
    \u0275\u0275listener("click", function StockRefillPage_Template_ion_button_click_25_listener() {
      return ctx.onShowClick();
    });
    \u0275\u0275text(26, " SHOW ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(27, StockRefillPage_ion_row_27_Template, 7, 0, "ion-row", 12)(28, StockRefillPage_div_28_Template, 37, 12, "div", 13);
    \u0275\u0275elementStart(29, "div", 14)(30, "ion-row", 15)(31, "ion-col", 16);
    \u0275\u0275template(32, StockRefillPage_ion_row_32_Template, 21, 17, "ion-row", 17);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(33, StockRefillPage_div_33_Template, 36, 9, "div", 18);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(14);
...
var StockRefillPage = _StockRefillPage;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StockRefillPage, { className: "StockRefillPage", filePath: "src/app/pages/reports/stock-refill/stock-refill.page.ts", lineNumber: 16 });
})();
export {
  StockRefillPage
};
