...
var _AutoLoginGuard = class _AutoLoginGuard {
...
_AutoLoginGuard.\u0275fac = function AutoLoginGuard_Factory(t) {
  return new (t || _AutoLoginGuard)(\u0275\u0275inject(Router), \u0275\u0275inject(AuthService));
};
_AutoLoginGuard.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _AutoLoginGuard, factory: _AutoLoginGuard.\u0275fac, providedIn: "root" });
var AutoLoginGuard = _AutoLoginGuard;

// src/app/pages/machines/machines.page.ts
function MachinesPage_ion_tab_button_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-tab-button", 6);
    \u0275\u0275element(1, "ion-icon", 7);
    \u0275\u0275text(2, " Stock ");
    \u0275\u0275elementEnd();
  }
}
var _MachinesPage = class _MachinesPage {
  constructor(route, machineService) {
    this.route = route;
...
_MachinesPage.\u0275fac = function MachinesPage_Factory(t) {
  return new (t || _MachinesPage)(\u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(MachineService));
};
_MachinesPage.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MachinesPage, selectors: [["app-machines"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 9, vars: 1, consts: [["slot", "bottom"], ["tab", "home"], ["name", "home-outline"], ["tab", "stock", 4, "ngIf"], ["tab", "live"], ["name", "radio-outline"], ["tab", "stock"], ["name", "file-tray-stacked-outline"]], template: function MachinesPage_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-tabs")(1, "ion-tab-bar", 0)(2, "ion-tab-button", 1);
    \u0275\u0275element(3, "ion-icon", 2);
    \u0275\u0275text(4, " Home ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, MachinesPage_ion_tab_button_5_Template, 3, 0, "ion-tab-button", 3);
  ...
  if (rf & 2) {
    \u0275\u0275advance(5);
    \u0275\u0275property("ngIf", ctx.stockVisible);
  }
}, dependencies: [IonIcon, IonTabButton, IonTabBar, IonTabs, CommonModule, NgIf, FormsModule] });
var MachinesPage = _MachinesPage;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MachinesPage, { className: "MachinesPage", filePath: "src/app/pages/machines/machines.page.ts", lineNumber: 16 });
})();
...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-KNKNTYNF.js").then((m) => m.LoginPage),
    canActivate: [AutoLoginGuard]
  },
  {
    path: "dashboard",
    loadComponent: () => import("./chunk-J6MROI7C.js").then((m) => m.DashboardPage),
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-VZCVGZUS.js").then((m) => m.HomePage),
            canActivate: [AuthGuard]
          }
        ]
      },
      {
        ...
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-CEYZ4ENN.js").then((m) => m.StockPage),
            canActivate: [AuthGuard]
          }
        ]
      },
      {
        ...
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-ZBKQIZ35.js").then((m) => m.LivePage),
            canActivate: [AuthGuard]
          }
        ]
      },
      {
        ...
        children: [
          {
            path: "",
            loadChildren: () => import("./chunk-MP3VSPXO.js").then((m) => m.machineReportRoutes),
            canActivate: [AuthGuard]
          }
        ]
      }
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-SYBPBGFO.js").then((m) => m.CategoryPage),
    canActivate: [AuthGuard]
  },
  {
    path: "products/:apptype",
    loadComponent: () => import("./chunk-2EBD57IB.js").then((m) => m.ProductsPage),
    canActivate: [AuthGuard]
  },
  {
    path: "stocks",
    loadComponent: () => import("./chunk-WKBXMWGW.js").then((m) => m.StocksPage),
    canActivate: [AuthGuard]
  },
  {
    path: "reports/current-stock",
    loadComponent: () => import("./chunk-LHQFZUD4.js").then((m) => m.CurrentStockPage),
    canActivate: [AuthGuard]
  },
  {
    path: "reports/stock-required",
    loadComponent: () => import("./chunk-NHREELI3.js").then((m) => m.StockRequiredPage),
    canActivate: [AuthGuard]
  },
  {
    path: "reports/sales",
    loadComponent: () => import("./chunk-HXT26XVA.js").then((m) => m.SalesPage),
    canActivate: [AuthGuard]
  },
  {
    path: "reports/sales-product",
    loadComponent: () => import("./chunk-N4S5HWK2.js").then((m) => m.SalesProductPage),
    canActivate: [AuthGuard]
  },
  {
    path: "reports/sales-user",
    loadComponent: () => import("./chunk-6ZP3DOQO.js").then((m) => m.SalesUserPage),
    canActivate: [AuthGuard]
  },
  {
    path: "reports/stock-refill",
    loadComponent: () => import("./chunk-OXHPOZRS.js").then((m) => m.StockRefillPage),
    canActivate: [AuthGuard]
  },
  {
    path: "reports/stock-cleared",
    loadComponent: () => import("./chunk-OY73N25H.js").then((m) => m.StockClearedPage),
    canActivate: [AuthGuard]
  },
  {
    path: "reports/stock-refill-summary",
    loadComponent: () => import("./chunk-AT5TPOXU.js").then((m) => m.StockRefillSummaryPage),
    canActivate: [AuthGuard]
  },
  {
    path: "reports/cash-refund-request",
    loadComponent: () => import("./chunk-SPIT5QBL.js").then((m) => m.CashRefundRequestPage)
  }
];
...
var _UserService = class _UserService {
  ...
  LoadUserAppTypes() {
    this.apiService.GetUserAppTypes().subscribe((types) => {
      this.appTypes = types;
    });
  }
};
...
var _c0 = () => ["/dashboard"];
var _c1 = () => ["dashboard"];
var _c2 = () => ["reports", "sales"];
var _c3 = () => ["reports", "sales-product"];
var _c4 = () => ["reports", "sales-user"];
var _c5 = () => ["reports", "cash-refund-request"];
var _c6 = () => ["category", "vm"];
var _c7 = () => ["products", "vm"];
var _c8 = () => ["category", "kiosk"];
var _c9 = () => ["products", "kiosk"];
var _c10 = () => ["stocks"];
var _c11 = () => ["reports", "current-stock"];
var _c12 = () => ["reports", "stock-required"];
var _c13 = () => ["reports", "stock-refill"];
var _c14 = () => ["reports", "stock-cleared"];
var _c15 = () => ["reports", "stock-refill-summary"];
function AppComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-accordion", 6)(1, "ion-item", 9)(2, "ion-label");
    \u0275\u0275text(3, "VENDING MACHINE");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 10)(5, "ion-menu-toggle", 3)(6, "ion-item", 5)(7, "ion-label");
    \u0275\u0275text(8, " Category ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "ion-item", 5)(10, "ion-label");
    \u0275\u0275text(11, " Products ");
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
...
function AppComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-accordion", 7)(1, "ion-item", 9)(2, "ion-label");
    \u0275\u0275text(3, "KIOSK");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 10)(5, "ion-menu-toggle", 3)(6, "ion-item", 5)(7, "ion-label");
    \u0275\u0275text(8, " Category ");
    ...
    \u0275\u0275text(11, " Products ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "ion-item", 5)(13, "ion-label");
    \u0275\u0275text(14, " Stocks ");
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    \u0275\u0275advance(6);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(3, _c8));
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(4, _c9));
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(5, _c10));
  }
}
function AppComponent_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-item", 5)(1, "ion-label");
    \u0275\u0275text(2, " Current Stocks ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "ion-item", 5)(4, "ion-label");
    \u0275\u0275text(5, " Stock Required ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "ion-item", 5)(7, "ion-label");
    \u0275\u0275text(8, " Stock Refills ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "ion-item", 5)(10, "ion-label");
    \u0275\u0275text(11, " Stock Cleared ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "ion-item", 5)(13, "ion-label");
    \u0275\u0275text(14, " Stock Refill Summary ");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(5, _c11));
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(9, _c15));
  }
}
function AppComponent_Conditional_34_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ion-content", 19)(1, "ion-list", 20)(2, "ion-list-header")(3, "ion-label");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "ion-item", 21);
    \u0275\u0275listener("click", function AppComponent_Conditional_34_ng_template_9_Template_ion_item_click_5_listener() {
      \u0275\u0275restoreView(_r1);
...
function AppComponent_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-header")(1, "ion-toolbar", 12)(2, "ion-buttons", 13);
    \u0275\u0275element(3, "ion-menu-button");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "ion-title", 14);
    \u0275\u0275element(5, "img", 15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "ion-buttons", 16);
    \u0275\u0275element(7, "ion-icon", 17);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(8, "ion-popover", 18);
    \u0275\u0275template(9, AppComponent_Conditional_34_ng_template_9_Template, 9, 1, "ng-template");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance(5);
...
var _AppComponent = class _AppComponent {
  constructor(router, authService, signalrService, userService) {
    this.router = router;
    this.authService = authService;
...
_AppComponent.\u0275fac = function AppComponent_Factory(t) {
  return new (t || _AppComponent)(\u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(SignlarService), \u0275\u0275directiveInject(UserService));
};
_AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 37, vars: 16, consts: [["accordionGroup", ""], ["contentId", "main-content", "type", "overlay"], ["id", "inbox-list"], ["auto-hide", "false"], [1, "ion-margin-bottom", 3, "routerLink"], ["routerDirection", "root", "lines", "none", "detail", "false", "routerLinkActive", "selected", 3, "routerLink"], ["value", "VM"], ["value", "KIOSK"], ["value", "REPORTS"], ["slot", "header", "color", "light"], ["slot", "content", 1, "ion-padding"], ["id", "main-content"], ["color", "primary"], ["slot", "start"], ["mode", "ios"], ["src", "../assets/images/Logo.png", "routerDirection", "root", 3, "routerLink"], ["slot", "end", "id", "userProfile"], ["name", "person-outline"], ["trigger", "userProfile", "triggerAction", "click"], [1, "ion-padding"], ["lines", "none", 1, "userMenu"], ["button", "", 3, "click"], ["slot", "start", "name", "log-out-outline"]], template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-app")(1, "ion-menu", 1)(2, "ion-content")(3, "ion-list", 2)(4, "ion-menu-toggle", 3)(5, "div", 4)(6, "ion-list-header");
    \u0275\u0275text(7, "BVC");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "ion-item", 5)(9, "ion-label");
    \u0275\u0275text(10, " Dashboard ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(11, "ion-accordion-group", null, 0);
    \u0275\u0275template(13, AppComponent_Conditional_13_Template, 12, 4, "ion-accordion", 6)(14, AppComponent_Conditional_14_Template, 15, 6, "ion-accordion", 7);
    \u0275\u0275elementStart(15, "ion-accordion", 8)(16, "ion-item", 9)(17, "ion-label");
    \u0275\u0275text(18, "REPORTS");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "div", 10)(20, "ion-menu-toggle", 3)(21, "ion-item", 5)(22, "ion-label");
    \u0275\u0275text(23, " Sales ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "ion-item", 5)(25, "ion-label");
    \u0275\u0275text(26, " Sales - Products ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "ion-item", 5)(28, "ion-label");
    \u0275\u0275text(29, " Sales - Users ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "ion-item", 5)(31, "ion-label");
    \u0275\u0275text(32, " Cash Refund Request ");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(33, AppComponent_Conditional_33_Template, 15, 10);
    \u0275\u0275elementEnd()()()()()()();
    \u0275\u0275template(34, AppComponent_Conditional_34_Template, 10, 2);
    \u0275\u0275elementStart(35, "ion-content");
    \u0275\u0275element(36, "ion-router-outlet", 11);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(5);
...
var _TokenInterceptorService = class _TokenInterceptorService {
  ...
  intercept(req, next) {
    ...
    return next.handle(this.addAuthorizationHeader(req, jwtToken)).pipe(catchError((err) => {
  ...
  refreshToken(request, next) {
    if (!this.refreshingInProgress) {
      ...
      return this.authService.RefreshTokens().pipe(switchMap((res) => {
        this.refreshingInProgress = false;
      ...
      return this.accessTokenSubject.pipe(filter((token) => token !== ""), take(1), switchMap((token) => {
...
_TokenInterceptorService.\u0275fac = function TokenInterceptorService_Factory(t) {
  return new (t || _TokenInterceptorService)(\u0275\u0275inject(AuthService), \u0275\u0275inject(AlertService), \u0275\u0275inject(Router));
};
_TokenInterceptorService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _TokenInterceptorService, factory: _TokenInterceptorService.\u0275fac, providedIn: "root" });
var TokenInterceptorService = _TokenInterceptorService;
